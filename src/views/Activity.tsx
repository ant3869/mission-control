...
import { Radio, GitBranch, BrainCircuit, Bot, Workflow, Zap, Clock, FileClock, SlidersHorizontal } from 'lucide-react'
  ...
  return (
    <TabHub
      ...
      tabs={[
        ...
        { id: 'controls', label: 'Controls',    icon: <SlidersHorizontal size={13} />, render: () => <Controls /> },
      ]}
    />
  )
}
